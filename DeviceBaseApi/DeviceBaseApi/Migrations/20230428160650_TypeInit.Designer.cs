...
namespace DeviceBaseApi.Migrations
{
    ...
    [Migration("20230428160650_TypeInit")]
            ...
            modelBuilder.Entity("DeviceBaseApi.DeviceModule.Device", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2660),
                            Description = "",
                            DeviceName = "SP611",
                            DevicePlacing = "None",
                            DeviceTypeId = 1,
                            Edited = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2660),
                            MqttUrl = "https://www.google.pl/",
                            Produced = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2660),
                            SerialNumber = "21371"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2670),
                            Description = "",
                            DeviceName = "SP611",
                            DevicePlacing = "None",
                            DeviceTypeId = 1,
                            Edited = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2670),
                            MqttUrl = "https://www.hivemq.com/",
                            Produced = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2680),
                            SerialNumber = "21372"
                        });
                });
            ...
            modelBuilder.Entity("DeviceBaseApi.DeviceTypeModule.DeviceType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2360),
                            DefaultName = "SP611",
                            Edited = new DateTime(2023, 4, 28, 18, 6, 50, 229, DateTimeKind.Local).AddTicks(2450),
